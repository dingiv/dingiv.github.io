...
玩本地 AI 部署，3090 是值得关注的一张卡，支持双卡组 nvlink，且二手价格 ok，可以考虑。详细的 AI 部署 GPU 选型（架构门槛、NVLink、AMD 对比、魔改卡风险）见 [GPU AI 部署参考](/ai/compute/deploy/gpu-ai)。
...
A6000、A5500、A5000、A4500 支持 nvlink。完整的 NVLink 桥接兼容性参考和 PCIe 替代方案见 [GPU AI 部署参考](/ai/compute/deploy/gpu-ai#nvlink-桥接参考)。
...
玩本地 AI 部署，7900xtx 是值得关注的一张卡，有 24GB 显存，可以考虑组多卡工作站。AMD 显卡在 AI 场景下的 ROCm 生态、框架兼容性和与 NVIDIA 的详细对比见 [GPU AI 部署参考](/ai/compute/deploy/gpu-ai#amd-显卡-ai-部署分析)。
